        ...
        <section
            ...
            {!status && (
                <div
                    ...
                    <button   aria-label="Close Modal"  onClick={() => setIsModalOpen(false)} className={"click-action bg-transparent border-0 d-none d-md-block p-2 position-absolute cursor-pointer r-5 t-5"}>
